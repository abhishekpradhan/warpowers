...
Run: blender --background --factory-startup --python tools/blender/build_mercc.py -- [--data DIR | --scratch DIR]
Outputs: data/Art/W3D/mercc01.w3d and data/Art/Textures/wp_mercc.tga (a 512px
